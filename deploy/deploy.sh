...
# code: if all 10 returned 0, the API accepted the change. If
# something is silently wrong we'll discover it the slow way
# (cost spike), but in practice fly machine update has been honest
# about its exit code.
